...
import { ArrowDown, ArrowRight, Zap, Globe, Shield, Star } from "lucide-react";
      ...
      <div className="max-w-6xl w-full mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {["React", "Next.js", "Node.js", "TypeScript", "AWS", "Flutter"].map((t) => (
                  <span
                    key={t}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <div style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.7rem", fontFamily: "'Space Grotesk', sans-serif" }}>
                Latest Project
              </div>
              <div className="mt-1 text-white" style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600, fontSize: "0.85rem" }}>
                AurisFi Fintech
              </div>
              <div className="mt-2 h-1 rounded-full overflow-hidden" style={{ background: "rgba(255,255,255,0.06)" }}>
                <div className="h-full rounded-full w-[88%]" style={{ background: "linear-gradient(90deg, #F0D060, #D4AF37)" }} />
              </div>
              <div className="mt-1 text-right" style={{ color: "#D4AF37", fontSize: "0.65rem", fontFamily: "'Fira Code', monospace" }}>88% deployed</div>
            </GlassCard>
            ...
            >
              ...
              <div className="flex gap-0.5 mt-1">
                {[...Array(5)].map((_, i) => (
                  <span key={i} style={{ color: "#D4AF37", fontSize: "0.7rem" }}>★</span>
                ))}
              </div>
              <div style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.65rem", fontFamily: "'Space Grotesk', sans-serif", marginTop: "2px" }}>
                from 80+ clients
              </div>
            </GlassCard>
          </div>
