    ...
    <footer className="pt-20 pb-10 px-4">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-10">
            ...
            <div className="md:col-span-1">
              ...
              <p style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.82rem", fontFamily: "'Space Grotesk', sans-serif", lineHeight: 1.7 }}>
                Building digital empires for ambitious brands since 2016.
              </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <Link
            to="/admin"
            style={{ color: "rgba(212,175,55,0.25)", fontSize: "0.72rem", fontFamily: "'Fira Code', monospace", textDecoration: "none", transition: "color 0.15s" }}
            onMouseEnter={(e) => ((e.target as HTMLAnchorElement).style.color = "rgba(212,175,55,0.6)")}
            onMouseLeave={(e) => ((e.target as HTMLAnchorElement).style.color = "rgba(212,175,55,0.25)")}
          >
            → admin panel
          </Link>
        </div>
