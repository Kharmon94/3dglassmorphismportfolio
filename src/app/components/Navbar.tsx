    ...
    >
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <Link
            to="/admin"
            className="ml-1 px-3 py-2 rounded-xl text-xs transition-all duration-200"
            style={{
            ...
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLAnchorElement).style.color = "rgba(212,175,55,0.4)";
              (e.currentTarget as HTMLAnchorElement).style.borderColor = "rgba(212,175,55,0.1)";
