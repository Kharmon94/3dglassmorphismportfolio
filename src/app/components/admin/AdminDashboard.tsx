...
import { FolderKanban, Eye, Star, FileX, ArrowRight, TrendingUp, Clock } from "lucide-react";
    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
          ...
          >
            ...
            >
              ...
              <Link
                ...
                style={{ color: "rgba(212,175,55,0.6)", fontFamily: "'Space Grotesk', sans-serif", textDecoration: "none" }}
        ...
        >
          ...
          <Link
            to="/admin/projects"
            className="block rounded-2xl p-5 transition-all duration-200 text-decoration-none"
            style={{
