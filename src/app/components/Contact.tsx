...
import { Mail, Send, Phone, MapPin, CheckCircle, Clock } from "lucide-react";
import { GlassCard } from "./GlassCard";
import { ThroneIcon } from "./ThroneIcon";

const contactInfo = [
  { icon: Mail,   label: "Email Us",  value: "hello@throneTech.dev", color: "#D4AF37", href: "mailto:hello@thronetech.dev" },
  { icon: Phone,  label: "Call Us",   value: "+1 (415) 555-0198",     color: "#C0C0C0", href: "tel:+14155550198" },
  { icon: MapPin, label: "HQ",        value: "San Francisco, CA",     color: "#D4AF37", href: "#" },
